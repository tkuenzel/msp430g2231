...
pub type P2DIR_W<'a, REG, const O: u8> = crate::FieldWriterSafe<'a, REG, 8, O>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn p0(&mut self) -> P0_W<P2DIR_SPEC, 0> {
        P0_W::new(self)
    }
    #[doc = "Bits 0:7 - Port 2 Direction register"]
    #[inline(always)]
    #[must_use]
    pub fn p2dir(&mut self) -> P2DIR_W<P2DIR_SPEC, 0> {
        P2DIR_W::new(self)
    }
    #[doc = "Bit 1 - P1"]
    #[inline(always)]
    #[must_use]
    pub fn p1(&mut self) -> P1_W<P2DIR_SPEC, 1> {
        P1_W::new(self)
    }
    #[doc = "Bit 2 - P2"]
    #[inline(always)]
    #[must_use]
    pub fn p2(&mut self) -> P2_W<P2DIR_SPEC, 2> {
        P2_W::new(self)
    }
    #[doc = "Bit 3 - P3"]
    #[inline(always)]
    #[must_use]
    pub fn p3(&mut self) -> P3_W<P2DIR_SPEC, 3> {
        P3_W::new(self)
    }
    #[doc = "Bit 4 - P4"]
    #[inline(always)]
    #[must_use]
    pub fn p4(&mut self) -> P4_W<P2DIR_SPEC, 4> {
        P4_W::new(self)
    }
    #[doc = "Bit 5 - P5"]
    #[inline(always)]
    #[must_use]
    pub fn p5(&mut self) -> P5_W<P2DIR_SPEC, 5> {
        P5_W::new(self)
    }
    #[doc = "Bit 6 - P6"]
    #[inline(always)]
    #[must_use]
    pub fn p6(&mut self) -> P6_W<P2DIR_SPEC, 6> {
        P6_W::new(self)
    }
    #[doc = "Bit 7 - P7"]
    #[inline(always)]
    #[must_use]
    pub fn p7(&mut self) -> P7_W<P2DIR_SPEC, 7> {
        P7_W::new(self)
    }
