...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ccifg(&mut self) -> CCIFG_W<TACCTL0_SPEC, 0> {
        CCIFG_W::new(self)
    }
    #[doc = "Bit 1 - Capture/compare overflow flag"]
    #[inline(always)]
    #[must_use]
    pub fn cov(&mut self) -> COV_W<TACCTL0_SPEC, 1> {
        COV_W::new(self)
    }
    #[doc = "Bit 2 - PWM Output signal if output mode 0"]
    #[inline(always)]
    #[must_use]
    pub fn out(&mut self) -> OUT_W<TACCTL0_SPEC, 2> {
        OUT_W::new(self)
    }
    #[doc = "Bit 3 - Capture input signal (read)"]
    #[inline(always)]
    #[must_use]
    pub fn cci(&mut self) -> CCI_W<TACCTL0_SPEC, 3> {
        CCI_W::new(self)
    }
    #[doc = "Bit 4 - Capture/compare interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn ccie(&mut self) -> CCIE_W<TACCTL0_SPEC, 4> {
        CCIE_W::new(self)
    }
    #[doc = "Bits 5:7 - Output mode 2"]
    #[inline(always)]
    #[must_use]
    pub fn outmod(&mut self) -> OUTMOD_W<TACCTL0_SPEC, 5> {
        OUTMOD_W::new(self)
    }
    #[doc = "Bit 8 - Capture mode: 1 /Compare mode : 0"]
    #[inline(always)]
    #[must_use]
    pub fn cap(&mut self) -> CAP_W<TACCTL0_SPEC, 8> {
        CAP_W::new(self)
    }
    #[doc = "Bit 10 - Latched capture signal (read)"]
    #[inline(always)]
    #[must_use]
    pub fn scci(&mut self) -> SCCI_W<TACCTL0_SPEC, 10> {
        SCCI_W::new(self)
    }
    #[doc = "Bit 11 - Capture sychronize"]
    #[inline(always)]
    #[must_use]
    pub fn scs(&mut self) -> SCS_W<TACCTL0_SPEC, 11> {
        SCS_W::new(self)
    }
    #[doc = "Bits 12:13 - Capture input select 1"]
    #[inline(always)]
    #[must_use]
    pub fn ccis(&mut self) -> CCIS_W<TACCTL0_SPEC, 12> {
        CCIS_W::new(self)
    }
    #[doc = "Bits 14:15 - Capture mode 1"]
    #[inline(always)]
    #[must_use]
    pub fn cm(&mut self) -> CM_W<TACCTL0_SPEC, 14> {
        CM_W::new(self)
    }
