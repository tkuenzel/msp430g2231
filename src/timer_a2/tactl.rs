...
pub type TAIFG_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type MC_W<'a, REG, const O: u8> = crate::FieldWriterSafe<'a, REG, 2, O, MC_A>;
impl<'a, REG, const O: u8> MC_W<'a, REG, O>
where
...
pub type ID_W<'a, REG, const O: u8> = crate::FieldWriterSafe<'a, REG, 2, O, ID_A>;
...
pub type TASSEL_W<'a, REG, const O: u8> = crate::FieldWriterSafe<'a, REG, 2, O, TASSEL_A>;
impl<'a, REG, const O: u8> TASSEL_W<'a, REG, O>
where
    REG: crate::Writable + crate::RegisterSpec,
    REG::Ux: From<u8>,
{
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn taifg(&mut self) -> TAIFG_W<TACTL_SPEC, 0> {
        TAIFG_W::new(self)
    }
    #[doc = "Bit 1 - Timer A counter interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn taie(&mut self) -> TAIE_W<TACTL_SPEC, 1> {
        TAIE_W::new(self)
    }
    #[doc = "Bit 2 - Timer A counter clear"]
    #[inline(always)]
    #[must_use]
    pub fn taclr(&mut self) -> TACLR_W<TACTL_SPEC, 2> {
        TACLR_W::new(self)
    }
    #[doc = "Bits 4:5 - Timer A mode control 1"]
    #[inline(always)]
    #[must_use]
    pub fn mc(&mut self) -> MC_W<TACTL_SPEC, 4> {
        MC_W::new(self)
    }
    #[doc = "Bits 6:7 - Timer A clock input divider 1"]
    #[inline(always)]
    #[must_use]
    pub fn id(&mut self) -> ID_W<TACTL_SPEC, 6> {
        ID_W::new(self)
    }
    #[doc = "Bits 8:9 - Timer A clock source select 1"]
    #[inline(always)]
    #[must_use]
    pub fn tassel(&mut self) -> TASSEL_W<TACTL_SPEC, 8> {
        TASSEL_W::new(self)
    }
