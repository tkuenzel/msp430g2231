...
pub type CCIFG_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type COV_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type CCI_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type OUTMOD_W<'a, REG, const O: u8> = crate::FieldWriterSafe<'a, REG, 3, O, OUTMOD_A>;
impl<'a, REG, const O: u8> OUTMOD_W<'a, REG, O>
where
...
pub type SCCI_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
#[doc = "Field `SCS` reader - Capture sychronize"]
pub type SCS_R = crate::BitReader;
#[doc = "Field `SCS` writer - Capture sychronize"]
pub type SCS_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type CCIS_W<'a, REG, const O: u8> = crate::FieldWriterSafe<'a, REG, 2, O, CCIS_A>;
impl<'a, REG, const O: u8> CCIS_W<'a, REG, O>
where
    REG: crate::Writable + crate::RegisterSpec,
    REG::Ux: From<u8>,
{
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ccifg(&mut self) -> CCIFG_W<TACCTL1_SPEC, 0> {
        CCIFG_W::new(self)
    }
    #[doc = "Bit 1 - Capture/compare overflow flag"]
    #[inline(always)]
    #[must_use]
    pub fn cov(&mut self) -> COV_W<TACCTL1_SPEC, 1> {
        COV_W::new(self)
    }
    #[doc = "Bit 2 - PWM Output signal if output mode 0"]
    #[inline(always)]
    #[must_use]
    pub fn out(&mut self) -> OUT_W<TACCTL1_SPEC, 2> {
        OUT_W::new(self)
    }
    #[doc = "Bit 3 - Capture input signal (read)"]
    #[inline(always)]
    #[must_use]
    pub fn cci(&mut self) -> CCI_W<TACCTL1_SPEC, 3> {
        CCI_W::new(self)
    }
    #[doc = "Bit 4 - Capture/compare interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn ccie(&mut self) -> CCIE_W<TACCTL1_SPEC, 4> {
        CCIE_W::new(self)
    }
    #[doc = "Bits 5:7 - Output mode 2"]
    #[inline(always)]
    #[must_use]
    pub fn outmod(&mut self) -> OUTMOD_W<TACCTL1_SPEC, 5> {
        OUTMOD_W::new(self)
    }
    #[doc = "Bit 8 - Capture mode: 1 /Compare mode : 0"]
    #[inline(always)]
    #[must_use]
    pub fn cap(&mut self) -> CAP_W<TACCTL1_SPEC, 8> {
        CAP_W::new(self)
    }
    #[doc = "Bit 10 - Latched capture signal (read)"]
    #[inline(always)]
    #[must_use]
    pub fn scci(&mut self) -> SCCI_W<TACCTL1_SPEC, 10> {
        SCCI_W::new(self)
    }
    #[doc = "Bit 11 - Capture sychronize"]
    #[inline(always)]
    #[must_use]
    pub fn scs(&mut self) -> SCS_W<TACCTL1_SPEC, 11> {
        SCS_W::new(self)
    }
    #[doc = "Bits 12:13 - Capture input select 1"]
    #[inline(always)]
    #[must_use]
    pub fn ccis(&mut self) -> CCIS_W<TACCTL1_SPEC, 12> {
        CCIS_W::new(self)
    }
    #[doc = "Bits 14:15 - Capture mode 1"]
    #[inline(always)]
    #[must_use]
    pub fn cm(&mut self) -> CM_W<TACCTL1_SPEC, 14> {
        CM_W::new(self)
    }
...
#[doc = "Timer A Capture/Compare Control 1\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`tacctl1::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`tacctl1::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
