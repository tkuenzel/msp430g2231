...
impl core::fmt::Debug for crate::generic::Reg<USISRL_SPEC> {
...
#[doc = "USI Low Byte Shift Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`usisrl::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`usisrl::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
