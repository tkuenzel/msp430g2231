...
pub type ADC10BUSY_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type CONSEQ_W<'a, REG, const O: u8> = crate::FieldWriterSafe<'a, REG, 2, O, CONSEQ_A>;
impl<'a, REG, const O: u8> CONSEQ_W<'a, REG, O>
where
...
pub type ADC10SSEL_W<'a, REG, const O: u8> = crate::FieldWriterSafe<'a, REG, 2, O, ADC10SSEL_A>;
impl<'a, REG, const O: u8> ADC10SSEL_W<'a, REG, O>
where
    REG: crate::Writable + crate::RegisterSpec,
    REG::Ux: From<u8>,
{
...
pub type ADC10DIV_W<'a, REG, const O: u8> = crate::FieldWriterSafe<'a, REG, 3, O, ADC10DIV_A>;
impl<'a, REG, const O: u8> ADC10DIV_W<'a, REG, O>
where
    REG: crate::Writable + crate::RegisterSpec,
    REG::Ux: From<u8>,
{
...
pub type ISSH_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type ADC10DF_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type SHS_W<'a, REG, const O: u8> = crate::FieldWriterSafe<'a, REG, 2, O, SHS_A>;
impl<'a, REG, const O: u8> SHS_W<'a, REG, O>
where
    REG: crate::Writable + crate::RegisterSpec,
    REG::Ux: From<u8>,
{
...
pub type INCH_W<'a, REG, const O: u8> = crate::FieldWriterSafe<'a, REG, 4, O, INCH_A>;
impl<'a, REG, const O: u8> INCH_W<'a, REG, O>
where
    REG: crate::Writable + crate::RegisterSpec,
    REG::Ux: From<u8>,
{
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn adc10busy(&mut self) -> ADC10BUSY_W<ADC10CTL1_SPEC, 0> {
        ADC10BUSY_W::new(self)
    }
    #[doc = "Bits 1:2 - ADC10 Conversion Sequence Select 0"]
    #[inline(always)]
    #[must_use]
    pub fn conseq(&mut self) -> CONSEQ_W<ADC10CTL1_SPEC, 1> {
        CONSEQ_W::new(self)
    }
    #[doc = "Bits 3:4 - ADC10 Clock Source Select Bit: 0"]
    #[inline(always)]
    #[must_use]
    pub fn adc10ssel(&mut self) -> ADC10SSEL_W<ADC10CTL1_SPEC, 3> {
        ADC10SSEL_W::new(self)
    }
    #[doc = "Bits 5:7 - ADC10 Clock Divider Select Bit: 0"]
    #[inline(always)]
    #[must_use]
    pub fn adc10div(&mut self) -> ADC10DIV_W<ADC10CTL1_SPEC, 5> {
        ADC10DIV_W::new(self)
    }
    #[doc = "Bit 8 - ADC10 Invert Sample Hold Signal"]
    #[inline(always)]
    #[must_use]
    pub fn issh(&mut self) -> ISSH_W<ADC10CTL1_SPEC, 8> {
        ISSH_W::new(self)
    }
    #[doc = "Bit 9 - ADC10 Data Format 0:binary 1:2's complement"]
    #[inline(always)]
    #[must_use]
    pub fn adc10df(&mut self) -> ADC10DF_W<ADC10CTL1_SPEC, 9> {
        ADC10DF_W::new(self)
    }
    #[doc = "Bits 10:11 - ADC10 Sample/Hold Source Bit: 0"]
    #[inline(always)]
    #[must_use]
    pub fn shs(&mut self) -> SHS_W<ADC10CTL1_SPEC, 10> {
        SHS_W::new(self)
    }
    #[doc = "Bits 12:15 - ADC10 Input Channel Select Bit: 0"]
    #[inline(always)]
    #[must_use]
    pub fn inch(&mut self) -> INCH_W<ADC10CTL1_SPEC, 12> {
        INCH_W::new(self)
    }
...
#[doc = "ADC10 Control 1\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`adc10ctl1::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`adc10ctl1::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
